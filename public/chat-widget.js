(function () {
  ...
  function onUserRequest(message) {
    ...
    let response = '';
    if (promptCount === 0) {
      response = 'The TVL on Sep 17,2022 was $3.268bn';
    } else if (promptCount === 1) {
      response = " Your wallet's total volume include inflow and outflow is $156,786.";
    } else if (promptCount === 2) {
      response = 'You have made a net profit of $42,456.';
    } else if (promptCount === 3) {
      response = 'I am not designed to help with this, but currently highest yield is for $WIN';
    } else {
